...
def comparator(learner, instructor):
    if learner == instructor:
        ...
        print(colored("Test failed.output is not as expected output.", "red"))
...
def multiple_test(test_cases, target):
    ...
    if success == len(test_cases):
        ...
        print('\033[92m', success," Tests passed")
        print('\033[91m', len(test_cases) - success, " Tests failed")
        raise AssertionError("Not all tests were passed for {}. Check equations and avoid using global variables inside the function.".format(target.__name__))
